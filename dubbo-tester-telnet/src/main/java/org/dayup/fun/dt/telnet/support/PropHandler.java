package org.dayup.fun.dt.telnet.support;
...
import org.dayup.fun.dt.telnet.utils.FileUtils;
...
public class PropHandler {
    ...
    public static <T> T parse(Class<T> clazz, boolean isClassPath) {
        try {
            ...
            if (isClassPath) {
                properties = readWithClassPath(LINE + propFile.value());
            } else {
                properties = readWithUserPath(LINE + propFile.value());
            }
